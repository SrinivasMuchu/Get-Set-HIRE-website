    ...
    if(type==='candidate'){
      ...
      if(firsebaseUser){
        if(firsebaseUser.data().type==='candidate'){
          ...
          alert('you are trying to signIn as candidate but you are already exist as employer')
      ...
      if(firsebaseUser){
        if(firsebaseUser.data().type==='employer'){
          ...
          //user exist as candidate
          //show him error message
          alert('you are trying to signIn as employer but you are already exist as candidate',)
        }
      }
      else{
